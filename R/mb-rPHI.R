...
phi = read.delim('~/DATA/MarbGenomics/PHI_output_mafft_genafpair.txt') 
phi = read.delim('~/DATA/MarbGenomics/PHI_output.txt') 
...
phi$NSS_SIG = ifelse(phi$OG %in% PHISigList[['NSS']],TRUE,FALSE)
...
phihits2 = phi[phi$ALL_SIG == TRUE,]$OG
